...
from utils.formatacao import NOME_LOJA, TELEFONE_WHATSAPP, TELEFONE_EXIBICAO, INSTAGRAM_ARROBA, INSTAGRAM_URL

# ==========================================================
# CONFIGURAÇÃO DA PÁGINA (DINÂMICO)
# ==========================================================
st.set_page_config(
    page_title=f"{NOME_LOJA} | Vitrine Oficial",
    page_icon="🎁",
    layout="wide",
...
.header-banner {
    ...
    background: linear-gradient(135deg, #ffffff 0%, #fdfbf8 100%); padding: 24px 30px;
...
.info-card {
    background: linear-gradient(145deg, #ffffff 0%, #fdfcfb 100%); border: 1px solid #e8ddd3; border-radius: 18px; padding: 20px 28px; 
    box-shadow: 0 4px 15px rgba(90, 59, 40, 0.03); display: flex; flex-direction: column; height: 100%; position: relative; top: 0; transition: all 0.3s ease;
}
...
div[data-testid="stTabs"] button { font-family: 'Montserrat', sans-serif !important; font-weight: 700 !important; font-size: 16px !important; color: #8c7362 !important; padding-bottom: 10px !important; }
div[data-testid="stTabs"] button[aria-selected="true"] { color: #c5721f !important; border-bottom-color: #c5721f !important; }

div[data-testid="stVerticalBlockBorderWrapper"] {
    background: #ffffff; border: 1px solid #e8ddd3 !important; border-radius: 20px !important; padding: 24px !important; margin-bottom: 20px !important; 
    box-shadow: 0 4px 15px rgba(90, 59, 40, 0.03); position: relative; top: 0; transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1) !important;
}
...
div[data-testid="stButton"] button {
    background: linear-gradient(135deg, #c5721f 0%, #9e520b 100%) !important; color: white !important; border-radius: 14px !important;  height: 54px !important;
    font-size: 16px !important; font-weight: 800 !important; border: none !important; box-shadow: 0 4px 15px rgba(197, 114, 31, 0.25) !important; position: relative; 
    top: 0; transition: all 0.3s ease !important; text-transform: uppercase; letter-spacing: 1px;
}
...
st.markdown(
    ...
    <div class="header-banner">
        ...
        <div class="header-text">
            <h1 class="header-title">{NOME_LOJA}</h1>
                ...
                with st.container(border=True):
                    ...
                    with col_text:
                        ...
                        if cesta.get("descricao") and str(cesta["descricao"]).strip():
                            descricao_txt = str(cesta["descricao"]).replace("\n", "<br>")
...
if produtos_adicionais:
    ...
    for prod in produtos_adicionais:
        ...
        if preco_p is not None and str(preco_p).strip() != "":
            ...
            except: span_preco = '<span class="adicional-preco-consulta">Consulta</span>'
        else: span_preco = '<span class="adicional-preco-consulta">Consulta</span>'
...
# ==========================================================
# SEÇÃO DE CONTATOS E RODAPÉ (LENDO DA FORMATAÇÃO CENTRAL)
# ==========================================================
...
st.markdown(
    ...
    <div class="footer-container">
        ...
        <div class="social-btn-box">
            <a href="{link_wpp}" target="_blank" class="btn-whatsapp">
                💬 {TELEFONE_EXIBICAO}
            </a>
            <a href="{INSTAGRAM_URL}" target="_blank" class="btn-instagram">
                📸 {INSTAGRAM_ARROBA}
            </a>
        </div>
    </div>
...
st.markdown(f'<div style="text-align:center; font-size:12px; color:#888; font-weight: 500;">{NOME_LOJA} © {date.today().year}</div>', unsafe_allow_html=True)
