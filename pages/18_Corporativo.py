...
@media print {
    ...
    div[data-testid="stCheckbox"], div[data-baseweb="select"], input {
        display: none !important;
    }
    div[data-testid="stVerticalBlockBorderWrapper"] { border: none !important; box-shadow: none !important; padding: 0 !important; margin: 0 !important;}
...
with aba_proposta:
    ...
    with st.container(border=True):
        st.markdown('<div class="corp-title">🎁 2. Adicionar Itens ao Contrato (Pacotes e Extras)</div>', unsafe_allow_html=True)
    ...
    with st.container(border=True):
        st.markdown('<div class="corp-title">💰 3. Logística, Desconto e Fechamento</div>', unsafe_allow_html=True)
