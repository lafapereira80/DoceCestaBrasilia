...
# ==========================================================
# TELA DE SUCESSO (HTML BLINDADO COM UNSAFE_ALLOW_HTML)
# ==========================================================
...
# ==========================================================
# PAGAMENTO E CÁLCULO DE VALORES
# ==========================================================
with st.container(border=True):
...
if cesta:
    with st.container(border=True):
        ...
        if tem_adicional_consulta: 
            st.warning("⚠️ Existem itens com valor sob consulta. Nossa equipe confirmará o valor final com você.")
...
if enviar:
    ...
    # Textos formatados para exibição amigável no banco e resumo
