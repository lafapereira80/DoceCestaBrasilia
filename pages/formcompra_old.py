...
if polaroid:
    with st.container(border=True):
        ...
        fotos = st.file_uploader("Selecione as imagens", type=["jpg", "jpeg", "png", "webp"], accept_multiple_files=True, key="upload_polaroid")
else:
    fotos = []


# ==========================================================
# HOMENAGEADO E ENTREGA (NOVA ÁREA UNIFICADA)
# ==========================================================
...
Recebemos seu pedido. Nossa equipe entrará em contato para confirmar detalhes finais e o frete.
"""
        )
    else:
